<?php
// Heading
$_['heading_title']       = 'Filters Groups';
...
$_['error_name']          = 'Filter Group Name must be between 3 and 64 characters!';
$_['error_filter']        = 'Warning: This filter group cannot be deleted as it is currently assigned to %s filters!';
$_['error_filter_module'] = 'Warning: This filter group cannot be deleted as it is currently assigned to %s modules!';
?>