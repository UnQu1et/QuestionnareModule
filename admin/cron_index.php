...
//require_once('/home/onik/data/www/vipestore.controlzone.ru/admin/config.php');
...
$_GET['profile'] = 'Ostatki2014';

if(@$_GET['profile']){
    define('PROFILE_NAME', $_GET['profile']);
}else{
    if ($argc > 1 && $argv[1]) {
