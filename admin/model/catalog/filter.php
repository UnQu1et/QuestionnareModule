...
class ModelCatalogFilter extends Model {
  ...
  public function addOption($data) {
	...
	$this->db->query("INSERT INTO `" . DB_PREFIX . "category_option` SET status = '" . (int)$data['status'] . "',required = '" . (int)$data['required'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
  ...
  public function editOption($option_id, $data) {
	...
	$this->db->query("UPDATE `" . DB_PREFIX . "category_option` SET status = '" . (int)$data['status'] . "', required = '" . (int)$data['required'] . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE option_id = '" . (int)$option_id . "'");
