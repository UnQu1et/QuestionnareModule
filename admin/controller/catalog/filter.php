...
class ControllerCatalogFilter extends Controller {
	...
	} elseif (isset($option_info['required'])) {
	...
	$this->data['type_groups'][] = array('value' => 'prices',
										 'text'  => 'text_prices');
	$this->data['type_groups'][] = array('value' => 'names',
										 'text'  => 'text_names');
	$this->data['type_groups'][] = array('value' => 'quantitys',
										 'text'  => 'text_quantity');
	...
	private function getStyles()
	{
		...
		$styles['textform'] = $this->language->get('style_textform');
		$styles['text'] = $this->language->get('style_text');
		return $styles;
	...
	{	
	 ...
	 private function getTypes()
	 {
		...
		$types['names']['name'] = array('value' => $this->language->get('text_names'));
		$types['quantitys']['quantity'] = array('value' => $this->language->get('text_quantity'));
