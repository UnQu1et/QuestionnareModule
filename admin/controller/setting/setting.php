...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['add_config_email'])) {
			$this->data['add_config_email'] = $this->request->post['add_config_email'];
		} else {
			$this->data['add_config_email'] = $this->config->get('add_config_email');
		}

		if (isset($this->request->post['add_config_email2'])) {
			$this->data['add_config_email2'] = $this->request->post['add_config_email2'];
		} else {
			$this->data['add_config_email2'] = $this->config->get('add_config_email2');
		}
