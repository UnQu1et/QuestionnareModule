...
class ControllerShippingPochtaros extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['pochtaros_zone'])) {
			$this->data['pochtaros_zone'] = $this->request->post['pochtaros_zone'];
		} else {
			$this->data['pochtaros_zone'] = $this->config->get('pochtaros_zone');
		}
