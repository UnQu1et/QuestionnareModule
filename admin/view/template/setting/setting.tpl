	  ...
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<div id="tab-general">
		  <table class="form">
			...
			<tr>
			  <td>Доп.  E-Mail (мск.):</td>
			  <td><input type="text" name="add_config_email" value="<?php echo $add_config_email; ?>" size="40" /></td>
			</tr>
			
			<tr>
			  <td>Доп.  E-Mail №2 (остальное.):</td>
			  <td><input type="text" name="add_config_email2" value="<?php echo $add_config_email2; ?>" size="40" /></td>
			</tr>
			<tr>
