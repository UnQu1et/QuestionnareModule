...
<?php } ?>
	<table class="simplecheckout-cart">
		...
		<thead>
			<tr>
				...
				<th class="model">Фабрика</th>
				<th class="name"><?php echo $column_name; ?></th>
				<th class="name">Ед. изм.</th>
				<th class="name">Характеристика</th>
				<th class="name">Склад</th>				
	...
	<?php foreach ($products as $product) { ?>
		<tr>
			...
			<td class="model"><?php echo $product['manufacturer_name']; ?></td>
			<td class="name">
			...
			<td class="name">			   
				<?php echo $attribute_products[$product['product_id']][13]['value']; if(!$attribute_products[$product['product_id']][13]['value']){ echo '-';}?>
			</td>
			<td class="name">			   
				<?php echo $attribute_products[$product['product_id']][14]['value'];if(!$attribute_products[$product['product_id']][14]['value']){ echo '-';}?>
			</td>
			<td class="name">				
				<?php echo $option_products[$product['product_id']][13][49]['option_val_name'];if(!$option_products[$product['product_id']][13][49]['option_val_name']){ echo '-';}?>
			</td>
