...
$_['text_services']         = 'Для начала работы в системе Ваш аккаунт должен быть активирован администратором системы. После успешной активации аккаунта Вы получите на эту почту электронное письмо с подтверждением активации и с Вашим логином и паролем. Благодарим за регистрацию. Если Вы не получите письмо об активации Вашей регистрации, обратитесь, пожалуйста в службу поддержки.';
