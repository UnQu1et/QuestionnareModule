...
class ControllerAccountDownload extends Controller {
	...
	public function downloadpage() {		
		...
		$res = $this->model_account_download->getPageDownloads();
		
		$downloads = array();
		foreach($res as $v){
			$downloads[$v['download_id']] = $v;
		}
		$download_info = $downloads[$this->request->get['download_id']];

		if ($download_info AND $download_info['mask'] == 'download') {
			$file = DIR_DOWNLOAD . $download_info['filename'];
